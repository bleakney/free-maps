...
## ✋Acceptance Criteria
  ...
  ` When I see the backend, the Application is backed by a MongoDB database with a GraphQL ODM and protects  sensitive information with environment variables. `
  `When I tries to interact with the app, the Application includes user authentication`
